...
class AnalizeTest {
    ...
    @Test
    void whenTreeAddedAndTreeDelete() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set previous = Set.of(u1, u2, u3);
        Set current = Set.of(new User(4, "D"), new User(5, "E"), new User(6, "F"));
        assertThat(Analize.diff(previous, current)).isEqualTo(new Info(3, 0, 3));
    }

    @Test
    void whenTreeChanngeAndTreeAdd() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set previous = Set.of(u1, u2, u3);
        Set current = Set.of(new User(1, "AA"), new User(2, "BB"), new User(3, "CC"), new User(4, "D"), new User(5, "E"), new User(6, "F"));
        assertThat(Analize.diff(previous, current)).isEqualTo(new Info(3, 3, 0));
    }
